      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-80 md:w-96 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50 max-h-80 md:max-h-96 overflow-hidden">
            ...
            {/* Footer */}
            <div className="px-2 py-0.5 border-t border-gray-200 dark:border-gray-700">
              <button className="w-full text-center py-0.5 text-xs text-blue-600 dark:text-blue-400 hover:underline">
