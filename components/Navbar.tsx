...
export default function Navbar({ 
  ...
  // Show username modal when wallet connects without username (only on mobile, desktop uses CustomConnectButton)
  useEffect(() => {
    if (isMobile && !isLoading && isConnected && !hasUsername && !hasCheckedMobile) {
      setShowUsernameModal(true);
      setHasCheckedMobile(true);
    }
  }, [isMobile, isConnected, hasUsername, isLoading, hasCheckedMobile]);
