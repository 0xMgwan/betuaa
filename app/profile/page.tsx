...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <Navbar />
      <div className="pt-20 md:pt-24 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pb-6 md:pb-12">
        {/* Profile Header with Gradient */}
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-2xl md:rounded-3xl p-4 md:p-8 mb-4 md:mb-8 shadow-2xl">
          <div className="absolute inset-0 bg-black/10"></div>
          <div className="relative flex items-center gap-3 md:gap-6">
            <div className="relative">
              <div className="absolute inset-0 bg-white/20 rounded-full blur-xl"></div>
              <div className="relative w-16 h-16 md:w-24 md:h-24 bg-white/10 backdrop-blur-xl rounded-full flex items-center justify-center text-white text-xl md:text-3xl font-bold border-2 md:border-4 border-white/20 shadow-xl">
                {username ? username.slice(0, 2).toUpperCase() : address?.slice(2, 4).toUpperCase()}
              </div>
            </div>
            <div className="flex-1">
              <h1 className="text-xl md:text-4xl font-black text-white mb-1 md:mb-2 drop-shadow-lg">
                {username || 'My Profile'}
              </h1>
              <p className="text-white/90 font-mono text-xs md:text-sm bg-white/10 backdrop-blur-sm px-2 md:px-3 py-0.5 md:py-1 rounded-lg inline-block">
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-6 mb-4 md:mb-8">
          <div className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl md:rounded-2xl p-3 md:p-6 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              <div className="flex items-center gap-1 md:gap-2 mb-2 md:mb-3">
                <div className="p-1 md:p-2 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg">
                  <TrendingUp className="w-3 h-3 md:w-5 md:h-5 text-white" />
                </div>
                <div className="text-[10px] md:text-sm font-medium text-gray-600 dark:text-gray-400">
                  Markets Created
                </div>
              </div>
              <div className="text-2xl md:text-4xl font-black bg-gradient-to-br from-blue-600 to-purple-600 bg-clip-text text-transparent">
                {markets.length}
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl md:rounded-2xl p-3 md:p-6 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative">
              ...
              <div className="text-2xl md:text-4xl font-black bg-gradient-to-br from-green-600 to-emerald-600 bg-clip-text text-transparent">
        ...
        {/* My Markets Section */}
        <div>
          <h2 className="text-xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 md:mb-6">
            My Markets
          </h2>
            ...
            <div className="grid grid-cols-1 gap-3 md:gap-6">
              {markets.map((market) => {
                ...
                return (
                  <div
                    key={market.id}
                    className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl md:rounded-2xl p-4 md:p-6 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
                  >
                    ...
                    <div className="relative">
                      <div className="flex items-start justify-between mb-3 md:mb-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-1.5 md:gap-2 mb-2 md:mb-3">
                            <span className="text-[10px] md:text-xs font-bold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 px-1.5 md:px-2 py-0.5 md:py-1 rounded-lg">
                              #{market.id}
                            </span>
                            <span
                          ...
                          <h3 className="font-bold text-sm md:text-lg text-gray-900 dark:text-white mb-1.5 md:mb-2 line-clamp-2">
                            {market.title}
                          </h3>
                      ...
                      {!market.resolved && !isActive && (
                        <button
                          ...
                          className="w-full mt-3 md:mt-4 px-3 md:px-4 py-2 md:py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg md:rounded-xl text-sm md:text-base font-bold shadow-lg shadow-blue-500/50 hover:shadow-xl hover:shadow-blue-500/50 transition-all duration-300"
                        >
                          Resolve Market
                        </button>
                      )}
